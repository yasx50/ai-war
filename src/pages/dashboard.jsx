...
import { Swords, User, LayoutDashboard, Zap, ChevronRight, Plus } from 'lucide-react';
...
const StatCard = ({ label, value, sub, color }) => (
  <Card className="bg-zinc-900/60 border-zinc-700/60">
    <CardContent className="pt-5 pb-5 px-5">
      ...
      <p className={cn('text-3xl font-black', color || 'text-white')}>{value}</p>
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-56 flex-shrink-0 flex flex-col gap-1 pt-2">
        ...
        <main className="flex-1 space-y-6">
          ...
          {profiles.length > 0 && (
            <Card className="bg-zinc-900/60 border-zinc-700/60">
              ...
              <CardContent className="pt-3 pb-4 px-5 space-y-2">
                {profiles.map((p) => (
                  <div
                    key={p._id}
