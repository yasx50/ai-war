...
const FeatureCard = ({ icon, title, desc }) => (
  <div className="p-5 rounded-2xl bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 transition-colors">
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        <Badge className="mb-6 bg-amber-500/15 text-amber-400 border border-amber-500/30 px-4 py-1">
        ...
        <p className="text-zinc-400 text-lg max-w-xl mb-10 leading-relaxed">
          ...
          Let AI simulate epic debates on any topic.
        </p>
        ...
        <div className="flex gap-3">
          <SignUpButton mode="modal">
            <Button className="h-12 px-8 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-black font-bold text-base shadow-xl shadow-amber-500/20">
          ...
          <SignInButton mode="modal">
            <Button
              variant="outline"
              className="h-12 px-8 border-zinc-700 bg-zinc-900 text-zinc-300 hover:bg-zinc-800 text-base"
            >
              Sign In
            </Button>
          </SignInButton>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-20 max-w-3xl w-full">
          ...
          <FeatureCard
            ...
            desc="Every account gets 1000 tokens to run debates. Use them wisely across all your battles."
          />
        </div>
      </main>
